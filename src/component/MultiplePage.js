...
import '../../css/component/MultiplePage';
...
export default class MultiplePage extends React.Component{
	...
	_resizePage(isAuto){
		...
		if(isAuto){
			list.style.height = node.offsetHeight + "px";
		}else{
			list.style.height = "100%";
		}
		
		list.style.paddingBottom = "2rem";
	...
	render(){
		...
		let componentClass = "component-multiple-page";
		if(this.props.autoHeight){
			componentClass = "component-multiple-page auto-height"
		}
